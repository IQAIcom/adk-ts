...
<Cards>
  ...
  <Card
    ...
    description="How the Runner orchestrates agent execution and event processing"
    href="/docs/framework/runtime/runner-orchestration"
  />

<Card
  title="📦 Event System"
  description="Events, EventActions, and the communication protocol"
  href="/docs/framework/runtime/event-system"
/>

<Card
  title="🤖 Agent Lifecycle"
  description="How agents execute from initialization to completion"
  href="/docs/framework/runtime/agent-lifecycle"
/>

<Card
  title="🧠 LLM Integration"
  description="LLM flows, processors, and tool calling within agents"
  href="/docs/framework/runtime/llm-integration"
/>

<Card
  title="📋 Complete Invocation Flow"
...
/>
  ...
  <Card
    title="⏮️ Session Rewind (Advanced)"
