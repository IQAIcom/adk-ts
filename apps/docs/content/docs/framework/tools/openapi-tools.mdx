...
Integrate REST APIs documented with [OpenAPI specifications](https://swagger.io/specification/) into your ADK agents. You can use the built-in `HttpRequestTool` for general API access or create type-safe custom tools with generated TypeScript types.
