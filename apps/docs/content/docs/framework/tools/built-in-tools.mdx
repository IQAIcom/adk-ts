...
| ----------------------- | -------------------------------- | --------------- |
| **GoogleSearch**        | Search the web for information   | Yes (API keys)  |
...
new GoogleSearch({
  ...
  // Optional parameters
  safe: "off", // or "active" for safe search
  siteSearch: "example.com", // restrict to specific site
  siteSearchFilter: "i", // "i" to include, "e" to exclude
