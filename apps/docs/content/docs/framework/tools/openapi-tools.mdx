...
Integrate REST APIs documented with [OpenAPI specifications](https://swagger.io/specification/) into your ADK-TS agents. You can use the built-in `HttpRequestTool` for general API access or create type-safe custom tools with generated TypeScript types.
...
For simple API access, use the built-in [`HttpRequestTool`](http://localhost:3000/docs/framework/tools/built-in-tools#httprequesttool):
