...
export function Hero() {
	return (
		<section className="relative overflow-hidden border-b landing-border">
					...
					<div>
						...
						>
							{featurePills.map((pill) => (
								<span
									key={pill}
									className="inline-flex items-center gap-1.5 rounded-full border landing-border bg-card/50 px-3 py-1 text-xs text-muted-foreground"
								>
