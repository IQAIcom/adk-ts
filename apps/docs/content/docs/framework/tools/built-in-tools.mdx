...
| `includeAnswer`            | boolean | Optional | Include LLM-generated answer (or "basic", "advanced")      |
| `includeRawContent`        | boolean | Optional | Include raw content (or "markdown", "text")                |
...
- Blocks dangerous patterns (fork bombs, disk operations, privilege escalation) - [view blocked patterns](https://github.com/IQAIcom/adk-ts/blob/main/packages/adk/src/tools/defaults/bash-tool.ts)
