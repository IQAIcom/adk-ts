...
<Cards>
  ...
  <Card
    title="🚀 Samples"
    description="Browse complete agent projects and real-world implementations"
  ...
  <Card
    title="📚 Examples"
    description="Learn ADK-TS features through progressive tutorials from simple to advanced"
