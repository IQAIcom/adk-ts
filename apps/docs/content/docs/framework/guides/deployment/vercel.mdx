...
- Tasks requiring execution beyond [Fluid Compute limits](https://vercel.com/docs/functions)
...
- Support [Fluid Compute](https://vercel.com/kb/guide/ai-agents) for AI agents (extended durations, background tasks)
...
- [Vercel Changelog 2025](https://vercel.com/changelog)
