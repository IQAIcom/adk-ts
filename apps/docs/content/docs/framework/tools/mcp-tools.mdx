...
[**View full list →**](/docs/mcp-servers)
...
[View all official servers →](https://github.com/modelcontextprotocol/servers)
...
[Browse more community servers →](https://github.com/punkpeye/awesome-mcp-servers)

### Third-Party Wrappers in ADK-TS

ADK-TS also includes convenience wrappers for popular third-party MCP servers:

- **`McpFilesystem()`** - File system operations (read/write/list)
- **`McpMemory()`** - Memory and note-taking capabilities

[View full list →](/docs/mcp-servers#third-party-wrappers)
...
[Learn how to integrate external MCP servers →](/docs/mcp-servers/external-mcps)
...
- [MCP Integration Examples](https://github.com/IQAIcom/adk-ts/tree/main/apps/examples/src/11-mcp-integrations) - Advanced patterns
...
<Cards>
  <Card
    title="📦 IQ AI's Built-in MCP Servers"
