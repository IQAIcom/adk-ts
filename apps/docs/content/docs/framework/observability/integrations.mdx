...
<Callout type="info">
**Note on Jaeger**: While Jaeger doesn't natively support metrics in its UI, the Jaeger collector can export metrics to other systems like Prometheus for visualization and monitoring.
</Callout>
