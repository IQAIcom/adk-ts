...
await telemetryService.initialize({
  ...
  otlpEndpoint: process.env.OTEL_EXPORTER_OTLP_ENDPOINT || 'https://your-backend.com/v1/traces',
  ...
  metricExportIntervalMs: parseInt(process.env.METRIC_EXPORT_INTERVAL_MS || '300000', 10),
