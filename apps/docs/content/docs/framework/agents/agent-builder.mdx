...
Wraps an existing agent instance with AgentBuilder's session management and runner interface:
...
AgentBuilder can wrap existing agent instances to provide session management and the fluent runner interface:
...
This is useful when you have pre-configured agents but want AgentBuilder's automatic session management and convenient runner interface.
