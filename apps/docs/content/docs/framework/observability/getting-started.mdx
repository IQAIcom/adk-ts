...
This guide will help you get started with observability in ADK-TS. You'll learn how to initialize the telemetry service, configure it for local development, and start collecting traces and metrics.
...
- Learn about [Distributed Tracing](/docs/framework/observability/tracing) to understand what gets traced
- Explore [Metrics](/docs/framework/observability/metrics) for performance monitoring
- Configure for [Production](/docs/framework/observability/production) with privacy controls
