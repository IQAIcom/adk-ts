...
1. **`changelog-entry.md`** — the changelog entry, ready to paste into the relevant `CHANGELOG.md`
2. **`release-notes.md`** — community-facing release notes, ready for GitHub Release or blog post

Save both files to the repo root. After writing, show the user a brief summary of what was generated and the file paths.
