...
| ----------------------- | -------------------------------- | --------------- |
| **GoogleSearchTool**    | Search the web for information   | Yes (API keys)  |
...
new GoogleSearchTool(); // Configuration is handled via environment variables or runtime arguments
