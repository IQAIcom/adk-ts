---
title: Plugins
description: Introduction to ADK-TS plugins
---
...
Plugins are not supported by the [ADK web
interface](/docs/framework/get-started/quickstart#web-based-interface-adk-web).
...
- [Model Fallback Plugin](/docs/framework/plugins/model-fallback-plugin): Automatically handles rate limit errors (429) by retrying with configurable delays and falling back to alternative models when the primary model is unavailable.
- [Reflect and Retry Tools](/docs/framework/plugins/reflect-and-retry): Automatically tracks tool execution failures and implements intelligent retry logic with guided feedback to help agents recover from errors and successfully complete tool operations.
- [Langfuse Plugin](/docs/framework/plugins/langfuse-plugin): Provides comprehensive observability and tracing for your agent workflows by integrating with Langfuse, enabling you to monitor user interactions, agent decisions, model calls, and tool executions with detailed performance metrics and debugging insights.
...
<Cards>
  ...
  <Card
    ...
    description="Learn about intelligent error recovery"
    href="/docs/framework/plugins/reflect-and-retry"
  />
  <Card
    title="📊 Langfuse Plugin"
    description="Set up comprehensive observability"
    href="/docs/framework/plugins/langfuse-plugin"
  />
  <Card
    title="🛠️ Agent Callbacks"
    description="Understand the relationship between Plugins and Agent-level callbacks"
    href="/docs/framework/callbacks"
  />
  <Card
    title="✨ Best Practices"
    description="Essential patterns and approaches for production-ready agents"
