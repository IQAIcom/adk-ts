---
title: Third-Party MCP Wrappers
...
Third-party wrappers follow the same simple pattern as IQ AI servers:
...
All third-party wrappers support these configuration options:
