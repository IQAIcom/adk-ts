...
ADK-TS provides wrapper functions for [IQ AI's MCP servers](/docs/mcp-servers) and popular third-party servers. These wrappers simplify configuration and handle connection details automatically. You can find the full list of available wrappers below.
...
- See [MCP Integration Examples](https://github.com/IQAIcom/adk-ts/blob/main/apps/examples/src/06-mcp-and-integrations) for advanced patterns
