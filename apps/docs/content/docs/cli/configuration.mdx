...
The ADK-TS CLI automatically discovers agents in your project through intelligent file scanning.
...
The ADK-TS CLI expects specific export patterns to recognize your agents. Each agent file must match one of the following patterns:
