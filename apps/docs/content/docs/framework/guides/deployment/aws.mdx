...
1. [**AWS Lambda (Serverless)**](#option-1-aws-lambda-serverless) — Best for request-driven APIs and intermittent workloads.
2. [**AWS ECS Fargate (Containers)**](#option-2-aws-ecs-fargate-containers) — Best for long-running agents, Discord/Telegram bots, and managed containers.
3. [**AWS EC2 (Virtual Machines)**](#option-3-aws-ec2-virtual-machines) — Best for custom infrastructure, high scale, and full control.
...
# Note: Ensure your build output is in the 'dist' folder
...
<Cards>
  ...
  <Card title="⚡ Vercel Deployment" href="./vercel">
