...
<Callout type="info" title="Free vs Pro">
  CoinGecko offers a free tier with basic rate limits suitable for development and testing. For production applications requiring higher rate limits and premium features, consider using `McpCoinGeckoPro`. For detailed pricing and plan comparison, visit [CoinGecko API Pricing](https://www.coingecko.com/en/api/pricing).
</Callout>
