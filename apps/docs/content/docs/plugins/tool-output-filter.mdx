...
<Callout type="warning" title="External Dependency">
  This plugin requires the `jq` command-line tool to be installed and available in your system's PATH. You can install it from [stedolan.github.io/jq](https://stedolan.github.io/jq/download/) or using your system's package manager.
</Callout>
