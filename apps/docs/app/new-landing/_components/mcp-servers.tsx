						...
						<div className="flex items-start justify-between gap-8 mb-12">
							<div>
								...
								<p className="text-white/50 text-lg max-w-2xl">
									Production-ready MCPs for blockchain, communication,
									prediction markets, and more. Use them standalone or integrate
									seamlessly with ADK-TS agents.
								</p>
							</div>

							{/* Explore All MCPs button - beside section header */}
							<a
								href="https://iqaicom.github.io/adk-ts/"
								target="_blank"
								rel="noopener noreferrer"
								className="group inline-flex items-center gap-3 px-6 py-3 border-2 border-[#FF1A88] bg-[#FF1A88]/10 hover:bg-[#FF1A88]/20 transition-all duration-300 whitespace-nowrap flex-shrink-0"
							>
								<span className="font-mono text-sm text-[#FF1A88]">
									Explore All MCPs
								</span>
								<ArrowRight className="w-4 h-4 text-[#FF1A88] group-hover:translate-x-1 transition-transform duration-300" />
							</a>
						</div>
							...
							<button
								...
								className={`px-6 py-3 font-mono text-sm whitespace-nowrap border transition-all duration-300 ${
									activeTab === category.id
										? "border-[#FF1A88] border-b-transparent bg-[#FF1A88]/20 text-[#FF1A88] relative z-10 shadow-[0_0_20px_rgba(255,26,136,0.3)]"
					...
					>
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
							{activeCategory.highlights.map((highlight) => (
								<div
									key={highlight.name}
									className="border border-white/10 bg-black/60 p-6 hover:border-[#FF1A88]/30 hover:bg-black/80 transition-all duration-300"
								>
									<div className="mb-4">
									...
									<div className="space-y-2">
										{highlight.features.map((feature) => (
											<div key={feature} className="flex items-start gap-2">
												<div className="w-1 h-1 bg-[#FF1A88] mt-2 flex-shrink-0" />
				...
				>
					<div className="flex flex-wrap gap-6 items-center justify-center">
						...
						<div className="flex flex-wrap gap-3 justify-center">
							<div className="px-4 py-2 border border-[#FF1A88]/30 bg-[#FF1A88]/10 rounded font-mono text-xs text-[#FF1A88]">
								ADK-TS v2.0+
							</div>
