...
This is the easiest way to deploy - Railway automatically detects your Node.js/TypeScript project and handles everything for you using **Railpack**, Railway's modern build system. **No Docker knowledge required.**
...
- Explore the [Docker deployment guide](/docs/framework/guides/deployment/docker) for self-hosted options
